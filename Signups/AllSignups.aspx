<%@ Page Title="All Signup Entries" Language="C#" MasterPageFile="~/SUP_Admin.master" AutoEventWireup="true" CodeFile="AllSignups.aspx.cs" Inherits="Signups_AllSignups" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
	...
	<div>
	<h2>
	Access Player's List for All Events
	</h2>
   ...
   <asp:Label ID="emailSuccess" runat="server" Text="Email Sent Successfully" ForeColor="Red" Font-Size="Large" Visible="False"></asp:Label>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <asp:HyperLink ID="lbContinue" runat="server" NavigateUrl="~/Signups/AllSignups.aspx" Visible="False">Continue</asp:HyperLink>
...
<!--					<td class="marked"><%# ((SignupEntry)Container.DataItem).Smarked %></td> -->
	...
	<div>
			<table id="Table1" cellspacing="1" 
				style="padding: 1px; width:450px">
				<tr>
					<td align="center" colspan="3">
						<h3>Player&#39;s List E-mail Message</h3>
					</td>
				</tr>
				<tr>
