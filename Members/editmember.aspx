    ...
    <div class="memberslist">
        <asp:Repeater ID="MainMemberRepeater" runat="server">
        	   <ItemTemplate>
                ...
                <th class="memberID">MSGA Network ID</th>
                <th class="hcp">Hcp</th>
    ...
    <asp:Panel ID="UpdatePanel1" runat="server">
        <asp:Label ID="lblPIDMissing" runat="server" Text="Player ID not in Database" 
			...
			<asp:TableHeaderCell Width="200px">
			    ...
			    <asp:TableRow>
			        <asp:TableCell runat="server" Width="200px" HorizontalAlign="Right">
                ...
                <asp:TableRow runat="server">
                    <asp:TableCell runat="server" HorizontalAlign="Right">
                        <asp:Label ID="lblMid" runat="server" Text="MSGA Network ID: "></asp:Label>
                ...
                <asp:TableRow runat="server">
                    <asp:TableCell runat="server" HorizontalAlign="Right">
                        <asp:Label ID="lblHcp" runat="server" Text="Handicap Index: "></asp:Label>
